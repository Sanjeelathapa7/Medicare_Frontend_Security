    ...
    <>
      <div className="min-h-screen flex items-center justify-center m-5 px-5">
        <div className="flex flex-col items-center justify-between w-full">
          <div className="w-1/2">
            <img src="../assets/images/cover.png" alt="BM" className="w-full h-auto" />
          </div>
          ...
          <div className='container '>
            ...
            <div className='w-full'>
              <figcaption className=' ps-5 ms-5 blockquote-footer'>Azithromycin</figcaption>
              <figcaption className='ps-5 ms-5 blockquote-footer'>Tear Eye Drops</figcaption>
              <figcaption className='ps-5 ms-5 blockquote-footer'>Levorest-5</figcaption>
